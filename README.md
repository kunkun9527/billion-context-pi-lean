...
Upstream dependency is pinned to `billion-context-pi@0.1.68`; delegation remains disabled in this lean wrapper.

## Context Savings

The benchmark below compares the same delegation-disabled configuration against upstream `0.1.68`.
...
| Item | Lean | Upstream `billion-context-pi@0.1.68` |
| --- | ---: | ---: |
| `compress` | 231 | 549 |
